...
const UserDashboard = () => {
  ...
  const data = [
    { label: "No. of ongoing projects", value: totalEmployee, icon: faUsers, color: "#0D6E6E" },
    { label: "Latest company announcements", value: activeEmployee, icon: faUserCheck, color: "#4CAF50" },
    { label: "Total Leave Taken", value: triggers, icon: faBolt, color: "#FF9800" },
    {
        ...
        <div className="subscription-chart">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={subscriptionData}>
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="losses" fill="#F44336" name="Issues" barSize={50} />
              <Bar dataKey="profit" fill="#4CAF50" name="Resolved" barSize={50} />
            </BarChart>
          </ResponsiveContainer>
        </div>
