...
const IndiaMart = () => {
  ...
  const businessApps = [
    {
      ...
      description:
        "Connect with Indian suppliers and buyers with the largest online B2B marketplace in India.",
    ...
    },
    {
      ...
      category: "Marketing",
      description:
        "Manage your business presence on Facebook and reach millions of potential customers.",
    ...
    },
    {
      ...
      description:
        "Grow your professional network and connect with industry leaders worldwide.",
    ...
    },
    {
      ...
      category: "E-commerce",
      description:
        "Create your online store with the most powerful e-commerce platform for businesses of all sizes.",
    ...
    },
    {
      ...
      description:
        "Manage your business listing on Google Search and Maps to attract more customers.",
    ...
    },
    {
      ...
      description:
        "Connect with your customers easily using tools to automate, sort and quickly respond to messages.",
    ...
    },
    {
      ...
      category: "E-commerce",
      description:
        "Manage your Amazon seller account and grow your business on the largest online marketplace.",
    ...
    },
    {
      ...
      description:
        "Manage your customer relationships, sales pipeline, and marketing campaigns in one place.",
    ...
    },
    {
      ...
      description:
        "Store and access your business documents securely with Google Drive integration.",
      icon: "https://logo.clearbit.com/google.com",
      ageRating: "4+",
      price: "Free",
      inAppPurchases: false,
    ...
    },
    {
      ...
      category: "Storage Integration",
      description:
        "Save and share your business files securely with Microsoft OneDrive.",
  ...
  const fetchCrmData = async (token) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/store/fetch-crm`,
        {
          method: "POST",
          headers: {
  ...
  const getCachedCrmData = async (token) => {
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/store/get-cached-crm`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleGetClick = (app) => {
    if (app.enabled) {
      ...
      if (app.requiresToken) {
        ...
        // Handle redirects for storage apps
        if (app.name === "Google Drive") {
          navigate("/googledrive");
        } else if (app.name === "OneDrive") {
          navigate("/microsoft");
        } else {
      ...
      alert(
        `${app.name} is coming soon! We're working to integrate this service. Currently only IndiaMart CRM is available for data fetching.`
      );
    }
  };
  ...
  const filteredApps = businessApps.filter(
    (app) =>
  ...
  const AppCard = ({ app }) => (
    <div
      className={`appStore-app-card ${app.featured ? "appStore-featured" : ""}`}
    ...
    >
      ...
      <div className="appStore-app-info">
        ...
        <div className="appStore-meta">
          ...
          <span>•</span>
          <span
            className={`appStore-price ${
              app.price === "Free" ? "appStore-free" : ""
            }`}
          >
            {app.price}
            {app.inAppPurchases ? " + In-app purchases" : ""}
          </span>
        </div>
        <button
          className={`appStore-download-btn ${
            app.enabled ? "" : "appStore-disabled-btn"
          }`}
        ...
        >
          {app.enabled ? (
            <>
              <span>Get</span>
              {app.price !== "Free" && (
                <span className="appStore-price-badge">{app.price}</span>
              )}
            </>
          ) : (
            "Coming Soon"
  ...
  return (
    <div className="appStore-app-store">
      <div className="appStore-fixed-header">
        <header className="appStore-header">
          <div className="appStore-header-content">
            ...
            <p className="appStore-subtitle">
              Boost your business with powerful tools
            </p>
          </div>
          {/* Remove the appStore-quick-access div */}
            ...
            <div className="appStore-crm-header">
              ...
              <div className="appStore-crm-controls">
                <div className="appStore-crm-stats">
                  ...
                  <span>
                    Last Updated:{" "}
                    {new Date(crmData.timestamp || Date.now()).toLocaleString()}
                  </span>
                </div>
      ...
      {showForm && (
        <div
          className="appStore-modal-overlay"
          ...
          <div className="appStore-modal" onClick={(e) => e.stopPropagation()}>
            <div className="appStore-modal-header">
              <div>
                ...
                <p className="appStore-modal-subtitle">
                  Enter your IndiaMart CRM key to fetch your leads
                </p>
              </div>
              {!loading && (
                <button
